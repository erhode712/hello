...
int main(int argc, char **argv) {
    ...
    double neonPink[] =         {255,  20, 147,  0.0,  0.92, 0.42, 0.0};
    double coral[] =            {255, 127,  80,  0.0,   0.5, 0.69, 0.0};
    double violet[] =           {238, 130, 238,  0.0,   0.45, 0.0, 0.07};
    ...
    const struct CMUnitTest tests[] = {
            ...
            cmocka_unit_test_prestate(testBidirectionalValues, &neonPink),
            cmocka_unit_test_prestate(testBidirectionalValues, &coral),
            cmocka_unit_test_prestate(testBidirectionalValues, &violet)
